        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-4">
              Event<span className="text-primary-500">Talk</span>
            </h3>
            <p className="text-gray-400 mb-6">
              Join us for the ultimate developer conference experience with industry-leading speakers and cutting-edge insights.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/speakers" className="text-gray-400 hover:text-primary-500 transition-colors">
                  Speakers
                </Link>
              </li>
              <li>
                <Link to="/schedule" className="text-gray-400 hover:text-primary-500 transition-colors">
                  Schedule
                </Link>
              </li>
              <li>
